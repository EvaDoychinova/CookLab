...
namespace CookLab.Data.Migrations
{
    ...
    [Migration("20201111101321_MakeRecipeIngredientEntityBaseDeletableObject")]
    partial class MakeRecipeIngredientEntityBaseDeletableObject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CookLab.Data.Models.VesselDimension", b =>
                {
                    b.HasOne("CookLab.Data.Models.CookingVessel", "CookingVessel")
                        .WithOne("VesselDimension")
                        .HasForeignKey("CookLab.Data.Models.VesselDimension", "CookingVesselId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
